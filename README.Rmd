...
You can install the development version of `feltr` from [GitHub](https://github.com/) with:
...
Once obtained, it can be loaded for persistent use with `feltr::set_felt_key('YOUR KEY', install = TRUE)`.
